...
class Window_1:
    def __init__(self, master):
        ...
        self.Frame = Frame(self.master, bg = 'navajowhite')
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Menu', font = ('arial',55,'bold'), bg = 'navajowhite', fg = 'Black')
        self.Lbl_Title.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Login_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief = 'ridge', bg = 'navajowhite', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_1.grid(row = 1, column =0)
        self.Login_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief = 'ridge',bg = 'navajowhite', bd = 15,
                                        font = ('arial',20,'bold'))
        self.Login_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.Label_Username = Label(self.Login_Frame_1, text = 'Username', font = ('arial',20,'bold'), bg = 'navajowhite', bd = 20)
        ...
        self.Label_Password = Label(self.Login_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = 'navajowhite', bd = 20)
        ...
        self.btnLogout = Button(self.Login_Frame_2, text = 'Logout', width = 10, font = ('airia',15,'bold'), command = self.Logout)
        self.btnLogout.grid(row = 3, column = 2, padx = 8, pady = 20)
    ...
    def Login(self):
        ...
        if (u == str('gauri') and p == str(12345)):
            self.__menu__()
        else:
    ...
    def Logout(self):
        self.Logout = tkinter.messagebox.askokcancel("Login System", "Confirm if you want to Logout")
        if self.Logout > 0:
            self.master.destroy()
            return
